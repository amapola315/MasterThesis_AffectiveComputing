            ...
            for video in range(18):
                try:
                    ...
                    emotion_data.append({
                        ...
                        "ECG_Baseline_Median_1": baseline_median[0],  # Nueva columna
                        "ECG_Baseline_Median_2": baseline_median[1],  # Nueva columna
                        ...
                        "ECG_Stimulus_Median_1": stimulus_median[0],  # Nueva columna
                        "ECG_Stimulus_Median_2": stimulus_median[1],  # Nueva columna
                    })
...
output_csv = r"C:\Thesis\Code\data\dreamer_data_raw.csv"
